...
var $author$project$Main$GotPartnersList = function (a) {
...
var $author$project$DecoderTradePartners$TradePartner = F4(
...
var $author$project$DecoderTradePartners$partnersDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$DecoderTradePartners$TradePartner,
	A2($elm$json$Json$Decode$field, 'nip_number', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'adress', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int));
var $author$project$Main$getPartnersList = $elm$http$Http$get(
	{
		expect: A2(
			$elm$http$Http$expectJson,
			A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Main$GotPartnersList),
			$elm$json$Json$Decode$list($author$project$DecoderTradePartners$partnersDecoder)),
		url: 'http://localhost:8000/trade_partners/'
	});
var $author$project$Main$init_trade_partner = {adress: '', name: '', nip_number: ''};
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		...
		var navbarCmd = _v1.b;
		return _Utils_Tuple2(
			{key: key, navbarState: navbarState, newTradePartner: $author$project$Main$init_trade_partner, nipValid: $author$project$Main$TooShort, tradePartners: $krisajenkins$remotedata$RemoteData$Loading, url: url},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[$author$project$Main$getPartnersList, navbarCmd])));
	});
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Main$GotAddPartnerHttpResponse = function (a) {
	return {$: 'GotAddPartnerHttpResponse', a: a};
};
...
var $author$project$DecoderTradePartners$partnersEncoder = function (trade_partner) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'nip_number',
				$elm$json$Json$Encode$string(trade_partner.nip_number)),
				_Utils_Tuple2(
				'name',
				$elm$json$Json$Encode$string(trade_partner.name)),
				_Utils_Tuple2(
				'adress',
				$elm$json$Json$Encode$string(trade_partner.adress))
			]));
};
...
var $author$project$Main$createNewPartner = function (partnerData) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$jsonBody(
				$author$project$DecoderTradePartners$partnersEncoder(partnerData)),
			expect: A2(
				$elm$http$Http$expectJson,
				A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Main$GotAddPartnerHttpResponse),
				$author$project$DecoderTradePartners$partnersDecoder),
			url: 'http://localhost:8000/trade_partners/'
		});
};
	...
	function (msg, model) {
		switch (msg.$) {
			case 'UpdateNIP':
				var nip = msg.a;
				var validity = msg.b;
				var partner = model.newTradePartner;
				var model_partner_new = _Utils_update(
					partner,
					{nip_number: nip});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{newTradePartner: model_partner_new, nipValid: validity}),
			...
			case 'AddPartnerHttp':
				return _Utils_Tuple2(
					model,
					$author$project$Main$createNewPartner(model.newTradePartner));
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{newTradePartner: $author$project$Main$init_trade_partner}),
					$author$project$Main$getPartnersList);
		}
	});
...
var $author$project$Main$AddPartnerHttp = {$: 'AddPartnerHttp'};
...
var $author$project$Main$UpdateNIP = F2(
	function (a, b) {
		return {$: 'UpdateNIP', a: a, b: b};
	});
var $author$project$Main$Valid = {$: 'Valid'};
var $elm$core$Basics$modBy = _Basics_modBy;
var $author$project$Main$validateNIP = function (nip) {
	...
	var nipValid = ($elm$core$String$length(nip) === 10) ? (_Utils_eq(
		...
		get_val(9)) ? $author$project$Main$Valid : $author$project$Main$Invalid) : $author$project$Main$TooShort;
	return A2($author$project$Main$UpdateNIP, nip, nipValid);
};
...
var $author$project$Main$viewTradePartnerAdd = function (model) {
	var trade_partner_data = model.newTradePartner;
	var nip_validity = function () {
		var _v0 = model.nipValid;
		switch (_v0.$) {
			case 'Valid':
				return _List_fromArray(
			...
			[
						...
						_Utils_ap(
							_List_fromArray(
								[
									...
									$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput($author$project$Main$validateNIP),
									$rundis$elm_bootstrap$Bootstrap$Form$Input$value(model.newTradePartner.nip_number)
								]),
							nip_validity)),
						A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								function (value) {
									return $author$project$Main$UpdatePartnerData(
										_Utils_update(
											trade_partner_data,
											{name: value}));
								}),
								$rundis$elm_bootstrap$Bootstrap$Form$Input$value(model.newTradePartner.name)
							]))
					])),
				A2(
				$rundis$elm_bootstrap$Bootstrap$Form$group,
				...
				_List_fromArray(
					[
						...
						$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$Main$AddPartnerHttp)
					]),
				_List_fromArray(
					[
...
var $author$project$Main$viewTableHeader = $rundis$elm_bootstrap$Bootstrap$Table$simpleThead(
	_List_fromArray(
		[
			A2(
...
var $author$project$Main$viewTradePartner = function (trade_partner) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(trade_partner.name)
					])),
				A2(
				$rundis$elm_bootstrap$Bootstrap$Table$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(trade_partner.nip_number)
					])),
				A2(
				$rundis$elm_bootstrap$Bootstrap$Table$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(trade_partner.adress)
					]))
			]));
};
var $author$project$Main$viewTradePartners = function (trade_partners) {
	return $rundis$elm_bootstrap$Bootstrap$Table$table(
		{
			...
			tbody: A2(
				...
				_List_Nil,
				A2($elm$core$List$map, $author$project$Main$viewTradePartner, trade_partners)),
			thead: $author$project$Main$viewTableHeader
		});
};
var $author$project$Main$viewPartnersOrError = function (model) {
	...
	switch (_v0.$) {
		...
		case 'Success':
			...
			return $author$project$Main$viewTradePartners(trade_partners);
		default:
			var httpError = _v0.a;
...
var $author$project$Main$viewTradePartnersTable = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$viewPartnersOrError(model)
					]))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$viewTradePartnersTable(model),
						A2(
						$elm$html$Html$h1,
						_List_fromArray(
							[
						...
						$author$project$Main$viewTradePartnerAdd(model)
					]))
			]),
		title: 'Site1'
	};
