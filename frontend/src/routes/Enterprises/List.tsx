...
function Content({ enterprises }: { enterprises: EnterpriseResponse[] }) {
    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                Header: "Opcje",
                Cell: (
                    { cell }: { cell: Cell<EnterpriseResponse> }) => {
            ...
            },
            {
                ...
                Cell: (
                    ...
                    if (fav_enterprise_id === cell.row.original.enterprise_id) {
                        return <Button
                            icon="chevron circle right" color="green" disabled />
                    } return (
                        <Button
    ...
    return (
        <>
            ...
            <Button primary content="Dodaj nową firmę" onClick={() => history.push('/enterprise/add')} />
