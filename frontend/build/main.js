...
var $author$project$Main$InvoiceMsg = function (a) {
	return {$: 'InvoiceMsg', a: a};
};
var $author$project$Main$NavbarMsg = function (a) {
	return {$: 'NavbarMsg', a: a};
};
var $author$project$Main$TradePartnersMsg = function (a) {
	return {$: 'TradePartnersMsg', a: a};
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $author$project$Invoice$GotAllInvoices = function (a) {
...
var $author$project$Backend$Query$allInvoices = function (object____) {
	return A4(
...
var $author$project$API$Objects$Invoice = F6(
	function (uuid, invoice_id, invoice_date, invoice_type, partner, invoiceposition) {
		return {invoice_date: invoice_date, invoice_id: invoice_id, invoice_type: invoice_type, invoiceposition: invoiceposition, partner: partner, uuid: uuid};
	});
var $author$project$Backend$Scalar$Date = function (a) {
	return {$: 'Date', a: a};
};
...
var $author$project$Backend$Scalar$defaultCodecs = {
	codecDate: {
		decoder: A2($elm$json$Json$Decode$map, $author$project$Backend$Scalar$Date, $dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$scalarDecoder),
...
var $author$project$Backend$ScalarCodecs$codecs = $author$project$Backend$Scalar$defineCodecs(
	{codecDate: $author$project$Backend$Scalar$defaultCodecs.codecDate});
...
var $author$project$Backend$Object$Invoice$invoiceDate = A4(
	$dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField,
	'ScalarCodecs.Date',
	'invoiceDate',
	_List_Nil,
	$author$project$Backend$Scalar$unwrapCodecs($author$project$Backend$ScalarCodecs$codecs).codecDate.decoder);
var $author$project$Backend$Object$Invoice$invoiceId = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'invoiceId', _List_Nil, $elm$json$Json$Decode$string);
var $author$project$API$Objects$InvoicePosition = F5(
	function (uuid, name, vat_rate, num_items, price_net) {
		return {name: name, num_items: num_items, price_net: price_net, uuid: uuid, vat_rate: vat_rate};
	});
...
var $author$project$Backend$Object$InvoicePosition$name = A4(
	$dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField,
	'(Maybe String)',
	'name',
	_List_Nil,
	$elm$json$Json$Decode$nullable($elm$json$Json$Decode$string));
var $author$project$Backend$Object$InvoicePosition$numItems = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'Float', 'numItems', _List_Nil, $elm$json$Json$Decode$float);
var $author$project$Backend$Object$InvoicePosition$priceNet = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'Float', 'priceNet', _List_Nil, $elm$json$Json$Decode$float);
var $author$project$Backend$Object$InvoicePosition$uuid = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'Int', 'uuid', _List_Nil, $elm$json$Json$Decode$int);
var $author$project$Backend$Enum$VatRates$V_00 = {$: 'V_00'};
var $author$project$Backend$Enum$VatRates$V_023 = {$: 'V_023'};
var $author$project$Backend$Enum$VatRates$V_05 = {$: 'V_05'};
var $author$project$Backend$Enum$VatRates$V_08 = {$: 'V_08'};
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $elm$json$Json$Decode$fail = _Json_fail;
var $author$project$Backend$Enum$VatRates$decoder = A2(
	$elm$json$Json$Decode$andThen,
	function (string) {
		switch (string) {
			case 'v_023':
				return $elm$json$Json$Decode$succeed($author$project$Backend$Enum$VatRates$V_023);
			case 'v_08':
				return $elm$json$Json$Decode$succeed($author$project$Backend$Enum$VatRates$V_08);
			case 'v_05':
				return $elm$json$Json$Decode$succeed($author$project$Backend$Enum$VatRates$V_05);
			case 'v_00':
				return $elm$json$Json$Decode$succeed($author$project$Backend$Enum$VatRates$V_00);
			default:
				return $elm$json$Json$Decode$fail('Invalid VatRates type, ' + (string + ' try re-running the @dillonkearns/elm-graphql CLI '));
		}
	},
	$elm$json$Json$Decode$string);
var $author$project$Backend$Object$InvoicePosition$vatRate = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'Enum.VatRates.VatRates', 'vatRate', _List_Nil, $author$project$Backend$Enum$VatRates$decoder);
var $author$project$API$FetchInvoices$invoicePositionSelection = A6($dillonkearns$elm_graphql$Graphql$SelectionSet$map5, $author$project$API$Objects$InvoicePosition, $author$project$Backend$Object$InvoicePosition$uuid, $author$project$Backend$Object$InvoicePosition$name, $author$project$Backend$Object$InvoicePosition$vatRate, $author$project$Backend$Object$InvoicePosition$numItems, $author$project$Backend$Object$InvoicePosition$priceNet);
var $author$project$Backend$Object$Invoice$invoicePositions = function (object____) {
	return A4(
		$dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForCompositeField,
		'invoicePositions',
		_List_Nil,
...
var $author$project$Backend$Enum$InvoiceType$Issued = {$: 'Issued'};
var $author$project$Backend$Enum$InvoiceType$Received = {$: 'Received'};
var $author$project$Backend$Enum$InvoiceType$decoder = A2(
	$elm$json$Json$Decode$andThen,
	function (string) {
		switch (string) {
			case 'received':
				return $elm$json$Json$Decode$succeed($author$project$Backend$Enum$InvoiceType$Received);
			case 'issued':
				return $elm$json$Json$Decode$succeed($author$project$Backend$Enum$InvoiceType$Issued);
			default:
				return $elm$json$Json$Decode$fail('Invalid InvoiceType type, ' + (string + ' try re-running the @dillonkearns/elm-graphql CLI '));
		}
	},
	$elm$json$Json$Decode$string);
var $author$project$Backend$Object$Invoice$invoiceType = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'Enum.InvoiceType.InvoiceType', 'invoiceType', _List_Nil, $author$project$Backend$Enum$InvoiceType$decoder);
...
var $author$project$Backend$Object$Invoice$partner = function (object____) {
	return A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForCompositeField, 'partner', _List_Nil, object____, $elm$core$Basics$identity);
};
...
var $author$project$Backend$Object$TradingPartner$adress = A4(
	$dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField,
	'(Maybe String)',
	'adress',
	_List_Nil,
...
var $author$project$Backend$Object$TradingPartner$name = A4(
	$dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField,
	'(Maybe String)',
	'name',
	_List_Nil,
	$elm$json$Json$Decode$nullable($elm$json$Json$Decode$string));
var $author$project$Backend$Object$TradingPartner$nipNumber = A4(
	$dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField,
	'(Maybe String)',
	'nipNumber',
	_List_Nil,
...
var $author$project$Backend$Object$Invoice$uuid = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'Int', 'uuid', _List_Nil, $elm$json$Json$Decode$int);
var $author$project$API$FetchInvoices$invoiceSelection = A7(
	$dillonkearns$elm_graphql$Graphql$SelectionSet$map6,
	$author$project$API$Objects$Invoice,
	$author$project$Backend$Object$Invoice$uuid,
	$author$project$Backend$Object$Invoice$invoiceId,
	$author$project$Backend$Object$Invoice$invoiceDate,
	$author$project$Backend$Object$Invoice$invoiceType,
	$author$project$Backend$Object$Invoice$partner($author$project$API$FetchTradePartners$partnersSelection),
	$author$project$Backend$Object$Invoice$invoicePositions($author$project$API$FetchInvoices$invoicePositionSelection));
var $author$project$API$FetchInvoices$getAllInvoices = $author$project$Backend$Query$allInvoices($author$project$API$FetchInvoices$invoiceSelection);
...
var $author$project$API$GraphQL$makeGraphQLQuery = F2(
	function (query, decodesTo) {
		return A2(
			$dillonkearns$elm_graphql$Graphql$Http$send,
			decodesTo,
			A2($dillonkearns$elm_graphql$Graphql$Http$queryRequest, $author$project$API$GraphQL$graphql_url, query));
	});
var $author$project$Invoice$fetchAllInvoices = A2(
	$author$project$API$GraphQL$makeGraphQLQuery,
	$author$project$API$FetchInvoices$getAllInvoices,
	A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Invoice$GotAllInvoices));
var $author$project$TradePartners$GotPartnersList = function (a) {
	return {$: 'GotPartnersList', a: a};
};
var $author$project$Backend$Query$allPartners = function (object____) {
	return A4(
		$dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForCompositeField,
		'allPartners',
		_List_Nil,
...
var $author$project$TradePartners$fetchAllPartners = A2(
	$author$project$API$GraphQL$makeGraphQLQuery,
	$author$project$API$FetchTradePartners$getAllPartners,
...
var $author$project$Navbar$NavbarMsg = function (a) {
	return {$: 'NavbarMsg', a: a};
};
var $author$project$Navbar$TradePartnersTab = {$: 'TradePartnersTab'};
...
var $author$project$Navbar$init = function () {
	var _v0 = $rundis$elm_bootstrap$Bootstrap$Navbar$initialState($author$project$Navbar$NavbarMsg);
	var navbarState = _v0.a;
	var navbarCmd = _v0.b;
	var model = {activeTab: $author$project$Navbar$TradePartnersTab, state: navbarState};
	return _Utils_Tuple2(model, navbarCmd);
}();
var $author$project$TradePartners$init = {
	newTradePartner: {adress: '', name: '', nip_number: ''},
	tradePartners: $krisajenkins$remotedata$RemoteData$Loading
};
var $elm$core$Platform$Cmd$map = _Platform_map;
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		var _v1 = $author$project$Navbar$init;
		var navbarstate = _v1.a;
		var navbarcmd = _v1.b;
		return _Utils_Tuple2(
			{invoices: $author$project$Invoice$init, key: key, navbar: navbarstate, tradePartners: $author$project$TradePartners$init, url: url},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						A2($elm$core$Platform$Cmd$map, $author$project$Main$NavbarMsg, navbarcmd),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$TradePartnersMsg, $author$project$TradePartners$fetchAllPartners),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$InvoiceMsg, $author$project$Invoice$fetchAllInvoices)
					])));
	});
...
var $author$project$Invoice$update = F2(
	function (msg, model) {
		var response = msg.a;
		return _Utils_Tuple2(
			_Utils_update(
...
var $author$project$TradePartners$GotNewPartnerResult = function (a) {
...
var $author$project$TradePartners$addNewPartner = function (trade_partner_data) {
	return A2(
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'AddPartner':
				return _Utils_Tuple2(
					model,
					$author$project$TradePartners$addNewPartner(model.newTradePartner));
			case 'UpdateForm':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, $author$project$TradePartners$fetchAllPartners);
		}
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'NavbarMsg':
				var navmsg = msg.a;
				var _v2 = A2($author$project$Navbar$update, navmsg, model.navbar);
				var navmodel = _v2.a;
				var navmsgin = _v2.b;
				var navmsgout = A2($elm$core$Platform$Cmd$map, $author$project$Main$NavbarMsg, navmsgin);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{navbar: navmodel}),
					navmsgout);
			case 'TradePartnersMsg':
				var tradepartnermsg = msg.a;
				var _v3 = A2($author$project$TradePartners$update, tradepartnermsg, model.tradePartners);
				var tradepartnermodel = _v3.a;
				var tradepartnercmd = _v3.b;
				var tradepartnercmdout = A2($elm$core$Platform$Cmd$map, $author$project$Main$TradePartnersMsg, tradepartnercmd);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{tradePartners: tradepartnermodel}),
					tradepartnercmdout);
			default:
				var subMsg = msg.a;
				var _v4 = A2($author$project$Invoice$update, subMsg, model.invoices);
				var outmodel = _v4.a;
				var cmd = _v4.b;
				var outcmd = A2($elm$core$Platform$Cmd$map, $author$project$Main$InvoiceMsg, cmd);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{invoices: outmodel}),
...
var $author$project$Invoice$viewEmptyRow = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Brak faktur')
				]))
		]));
var $author$project$Invoice$dateToString = function (date) {
	var payload = date.a;
	return payload;
};
var $author$project$Invoice$invoiceTypeToString = function (invtype) {
	if (invtype.$ === 'Received') {
		return 'Zakup';
	} else {
		return 'Sprzedaż';
...
var $author$project$Invoice$partnerToString = function (partner) {
	return A2($elm$core$Maybe$withDefault, '', partner.name) + (' | ' + A2($elm$core$Maybe$withDefault, '', partner.nip_number));
};
var $elm$core$List$sum = function (numbers) {
	return A3($elm$core$List$foldl, $elm$core$Basics$add, 0, numbers);
};
var $author$project$Invoice$sumNetPositions = function (positions) {
	var sumofposition = function (position) {
		return position.num_items * position.price_net;
	};
	return $elm$core$List$sum(
		A2($elm$core$List$map, sumofposition, positions));
};
var $author$project$Invoice$viewInvoiceRow = function (invoice) {
	return A2(
		$rundis$elm_bootstrap$Bootstrap$Table$tr,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$core$Maybe$withDefault, 'Unavailable', invoice.partner.name))
					])),
				A2(
				$rundis$elm_bootstrap$Bootstrap$Table$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(invoice.invoice_id)
					])),
				A2(
				$rundis$elm_bootstrap$Bootstrap$Table$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Invoice$dateToString(invoice.invoice_date))
					])),
				A2(
				$rundis$elm_bootstrap$Bootstrap$Table$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Invoice$invoiceTypeToString(invoice.invoice_type))
					])),
				A2(
				$rundis$elm_bootstrap$Bootstrap$Table$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Invoice$partnerToString(invoice.partner))
					])),
				A2(
				$rundis$elm_bootstrap$Bootstrap$Table$td,
				_List_Nil,
				_List_fromArray(
					[
						...
						$elm$core$String$fromFloat(
							$author$project$Invoice$sumNetPositions(invoice.invoiceposition)))
					]))
			]));
};
...
var $author$project$Invoice$viewTableHeader = $rundis$elm_bootstrap$Bootstrap$Table$simpleThead(
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Nazwa firmy')
				])),
			A2(
			$rundis$elm_bootstrap$Bootstrap$Table$th,
			_List_Nil,
...
var $author$project$Invoice$view = function (model) {
	var outbody = function () {
		var _v0 = model.allInvoices;
		switch (_v0.$) {
			case 'Loading':
				return $elm$html$Html$text('Wczytywanie danych ...');
			case 'Success':
				var data = _v0.a;
				var rows_data = function () {
					if (data.$ === 'Nothing') {
						return _List_fromArray(
							[$author$project$Invoice$viewEmptyRow]);
					} else {
						var datanonmiss = data.a;
						return A2($elm$core$List$map, $author$project$Invoice$viewInvoiceRow, datanonmiss);
					}
				}();
				return $rundis$elm_bootstrap$Bootstrap$Table$table(
					{
						options: _List_Nil,
						tbody: A2($rundis$elm_bootstrap$Bootstrap$Table$tbody, _List_Nil, rows_data),
						thead: $author$project$Invoice$viewTableHeader
					});
			default:
...
var $author$project$Navbar$view = function (model) {
	...
	var active = function (route) {
		return $rundis$elm_bootstrap$Bootstrap$Navbar$itemLinkActive(
			_List_fromArray(
				[
					$author$project$Route$href(route)
				]));
		...
		if (_v0.$ === 'TradePartnersTab') {
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Kontrahenci')
						])),
					A2(
					inactive,
					$author$project$Route$Invoices,
	...
	return A2(
		...
		A2(
			...
			A3(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('VatCalc')
					]),
				$rundis$elm_bootstrap$Bootstrap$Navbar$withAnimation(
					$rundis$elm_bootstrap$Bootstrap$Navbar$config($author$project$Navbar$NavbarMsg)))));
};
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $author$project$TradePartners$AddPartner = {$: 'AddPartner'};
var $author$project$TradePartners$UpdateForm = function (a) {
...
var $author$project$TradePartners$Invalid = {$: 'Invalid'};
var $author$project$TradePartners$TooShort = {$: 'TooShort'};
var $author$project$TradePartners$Valid = {$: 'Valid'};
var $elm$core$Basics$modBy = _Basics_modBy;
var $author$project$TradePartners$validateNIP = function (nip) {
	var get_val = function (number) {
		return A2(
			$elm$core$Maybe$withDefault,
			0,
			$elm$core$String$toInt(
				A3($elm$core$String$slice, number, number + 1, nip)));
	};
	var nipValid = ($elm$core$String$length(nip) === 10) ? (_Utils_eq(
		A2(
			$elm$core$Basics$modBy,
			11,
			((((((((get_val(0) * 6) + (get_val(1) * 5)) + (get_val(2) * 7)) + (get_val(3) * 2)) + (get_val(4) * 3)) + (get_val(5) * 4)) + (get_val(6) * 5)) + (get_val(7) * 6)) + (get_val(8) * 7)),
		get_val(9)) ? $author$project$TradePartners$Valid : $author$project$TradePartners$Invalid) : $author$project$TradePartners$TooShort;
	return nipValid;
};
...
var $author$project$TradePartners$viewTradePartnerAdd = function (newTradePartner) {
	var trade_partner_data = newTradePartner;
	var nip_validity = function () {
		var _v0 = $author$project$TradePartners$validateNIP(newTradePartner.nip_number);
		switch (_v0.$) {
			case 'Valid':
				return _List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('NIP')
							])),
						$rundis$elm_bootstrap$Bootstrap$Form$Input$text(
						_Utils_ap(
							_List_fromArray(
								[
									$rundis$elm_bootstrap$Bootstrap$Form$Input$id('nip'),
									...
									function (value) {
										return $author$project$TradePartners$UpdateForm(
											_Utils_update(
												trade_partner_data,
												{nip_number: value}));
									}),
									$rundis$elm_bootstrap$Bootstrap$Form$Input$value(newTradePartner.nip_number)
								]),
							nip_validity)),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Pobierz dane z gus')
							]))
					])),
				A2(
				$rundis$elm_bootstrap$Bootstrap$Form$group,
					...
					[
						...
						_List_fromArray(
							[
								...
								$rundis$elm_bootstrap$Bootstrap$Form$Input$value(newTradePartner.name)
							]))
					])),
				A2(
				$rundis$elm_bootstrap$Bootstrap$Form$group,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rundis$elm_bootstrap$Bootstrap$Form$Input$id('adress'),
								$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(
								function (value) {
									return $author$project$TradePartners$UpdateForm(
										_Utils_update(
								...
								$rundis$elm_bootstrap$Bootstrap$Form$Input$value(newTradePartner.adress)
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$TradePartners$AddPartner)
					]),
				_List_fromArray(
					[
...
var $author$project$TradePartners$viewTableHeader = $rundis$elm_bootstrap$Bootstrap$Table$simpleThead(
	_List_fromArray(
		[
			A2(
			$rundis$elm_bootstrap$Bootstrap$Table$th,
...
var $author$project$TradePartners$viewTradePartnerRow = function (trade_partner) {
	return A2(
		$rundis$elm_bootstrap$Bootstrap$Table$tr,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(trade_partner.id))
					])),
				A2(
				$rundis$elm_bootstrap$Bootstrap$Table$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$core$Maybe$withDefault, 'Unavailable', trade_partner.name))
					])),
				A2(
				$rundis$elm_bootstrap$Bootstrap$Table$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$core$Maybe$withDefault, 'Unavailable', trade_partner.nip_number))
					])),
				A2(
				$rundis$elm_bootstrap$Bootstrap$Table$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$core$Maybe$withDefault, 'Unavailable', trade_partner.adress))
					]))
			]));
};
var $author$project$TradePartners$viewTradePartners = function (trade_partners) {
	return $rundis$elm_bootstrap$Bootstrap$Table$table(
		{
			options: _List_Nil,
			tbody: A2(
				...
				_List_Nil,
				A2($elm$core$List$map, $author$project$TradePartners$viewTradePartnerRow, trade_partners)),
			thead: $author$project$TradePartners$viewTableHeader
		});
};
var $author$project$TradePartners$viewPartnersOrError = function (model) {
	...
	switch (_v0.$) {
		...
		case 'Success':
			...
			return $author$project$TradePartners$viewTradePartners(trade_partners);
		default:
			return A2(
				$elm$html$Html$h3,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('download failed')
					]));
	}
};
var $author$project$TradePartners$viewTradePartnersTable = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$TradePartners$viewPartnersOrError(model)
					]))
			]));
};
var $author$project$TradePartners$view = function (model) {
	return A2(
		$rundis$elm_bootstrap$Bootstrap$Grid$col,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$TradePartners$viewTradePartnersTable(model),
				A2(
				$elm$html$Html$h1,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Dodaj nową firmę')
					])),
				$author$project$TradePartners$viewTradePartnerAdd(model.newTradePartner)
			]));
};
var $author$project$Main$view = function (model) {
	var viewTradePartners = A2(
		$elm$html$Html$map,
		$author$project$Main$TradePartnersMsg,
		A2(
			$rundis$elm_bootstrap$Bootstrap$Grid$row,
			_List_Nil,
			_List_fromArray(
				[
					$author$project$TradePartners$view(model.tradePartners)
				])));
	var viewInvoices = A2(
		$elm$html$Html$map,
		$author$project$Main$InvoiceMsg,
		A2(
			$rundis$elm_bootstrap$Bootstrap$Grid$row,
			_List_Nil,
			_List_fromArray(
				[
					$author$project$Invoice$view(model.invoices)
				])));
	var view_all = function () {
		var _v0 = $author$project$Route$fromUrl(model.url);
		if (_v0.$ === 'Nothing') {
			return viewTradePartners;
		} else {
			if (_v0.a.$ === 'Invoices') {
				var _v1 = _v0.a;
				return viewInvoices;
